...
internal interface MovieApi {
    ...
    ---*/
    @GET("tv/on_the_air")
    fun tvOnAir(@Query("api_key") apiKey: String): Observable<Any>

    @GET("tv/airing_today")
    fun tvAiringToday(@Query("api_key") apiKey: String): Observable<Any>

    @GET("tv/popular")
    fun tvPopular(@Query("api_key") apiKey: String): Observable<Any>

    @GET("tv/top_rated")
    fun tvTopRated(@Query("api_key") apiKey: String): Observable<Any>
