...
class TVDetailActivity(private var isFavorite: Boolean = false) : AppCompatActivity(), TrailerRVAdapter.OnItemClick, ReviewRVAdapter.OnReviewItemClick {
    ...
    companion object {
        ...
        fun launch(
            ...
            intent.putExtra(ARG_TV_LIST, tvResult)
            intent.putExtra(ARG_DARK_COLOR, darkColor)
            intent.putExtra(ARG_LIGHT_COLOR, lightColor)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val movieItem = intent.getParcelableExtra<TvResult>(ARG_TV_LIST)
        ...
        Glide.with(this)
                .load(Constants.BASE_IMAGE_URL + Constants.POSTER_SIZE_500 + movieItem.posterPath)
